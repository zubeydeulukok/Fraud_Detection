...
if uploaded_file is not None:
    ...
    def user_input_features():       
        ...
        V7 = st.sidebar.slider('V7', float(df["V7"].min()), float(df["V7"].max()), float(-29.54), 0.01)
        V9 = st.sidebar.slider('V9', float(df["V9"].min()), float(df["V9"].max()), float(-6.65), 0.01)
        V10 = st.sidebar.slider('V10', float(df["V10"].min()), float(df["V10"].max()), float(-8.85), 0.01)
        V11 = st.sidebar.slider('V11', float(df["V11"].min()), float(df["V11"].max()), float(3.28), 0.01)
        V12 = st.sidebar.slider('V12', float(df["V12"].min()), float(df["V12"].max()), float(-11.17), 0.01)
        V14 = st.sidebar.slider('V14', float(df["V14"].min()), float(df["V14"].max()), float(-6.67), 0.01)
        V16 = st.sidebar.slider('V16', float(df["V16"].min()), float(df["V16"].max()), float(-8.24), 0.01)
        V17 = st.sidebar.slider('V17', float(df["V17"].min()), float(df["V17"].max()), float(-13.61), 0.01)
